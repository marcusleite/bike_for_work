...
/*
Stuff from the example that I'm currently not using
...
// The session options resave and saveUninitialized were added because
// for no specific reason other then their default values were deprecated.
app.use(session({ 
    secret: 'keyboard cat',
    resave: false,
